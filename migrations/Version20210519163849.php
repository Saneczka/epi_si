 ...
 */
final class Version20210519163849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, comment_content VARCHAR(600) DEFAULT NULL, user_id INT NOT NULL, image_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, image_id INT NOT NULL, image_name VARCHAR(45) DEFAULT NULL, image_desc VARCHAR(500) DEFAULT NULL, image_width INT DEFAULT NULL, image_height INT DEFAULT NULL, album_id INT NOT NULL, user_id INT NOT NULL, image_time_create DATETIME NOT NULL, type_id INT NOT NULL, image_col VARCHAR(45) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
